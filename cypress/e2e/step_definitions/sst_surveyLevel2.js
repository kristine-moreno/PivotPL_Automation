...
When('Students Level 2 have navigated to the onboarding page',()=>{
...
When('Students Level 2 click submit button',()=>{
    cy.log('I click submit button')
})

When('Students Level 2 should be able to submit answers to the survey', () => {
